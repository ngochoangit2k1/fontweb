...
export const ACTIVE_MAIL_EXPIRED = 60; // 60 minutes

export const CHANGE_MAIL_EXPIRED = 60; // 60 minutes

export const RESET_PASSWORD_EXPIRED = 30; // 30 minutes
...
export const VERIFY_EMAIL_EXPIRED = 60; // 60 SECONDS

export const OTP_CODE_EXPIRED = 60; // 60 seconds
