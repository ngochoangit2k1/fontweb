			...
			<div className=' w-[50%] '>
				...
				<div className='mt-4 bg-white px-3 py-3 text-black'>
					...
					<p className='mt-2'>
						...
						<Link href={''}>
							{' '}
							<span className='text-[#2270b0]'> Chỉnh sửa hồ sơ của bạn</span>.
						</Link>
						<Link href={''}>
							{' '}
					...
					<textarea
						id='message'
						rows='4'
						class='block p-2.5 w-full text-sm text-black rounded-lg border border-gray-300 focus:outline-none  focus:border-oranges hover:border-oranges dark:bg-gray-700  '
					></textarea>
