...
export const createDadCategoryValidator = validator(
  joi.object().keys({
...
export const createCategoryValidator = validator(
  joi.object().keys({
...
export const updateCategoryValidator = validator(
  joi.object().keys({
...
export const updateProductValidator = validator(
  joi.object().keys({
    id: joi.number().required(),
    categoryId: joi.number().required(),
    discountId: joi.number().allow(null, ""),
...
export const changeStatusProductValidator = validator(
  joi.object().keys({
    id: joi.number().required(),
