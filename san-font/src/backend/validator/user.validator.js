...
export const updateTypeValidator = validator(
  joi.object().keys({
...
export const updateUserProfileValidator = validator(
  joi.object().keys({
...
export const registUserAddressValidator = validator(
  joi.object().keys({
...
export const withdrawBonusValidator = validator(
  joi.object().keys({
...
export const setLevelUserValidator = validator(
  joi.object().keys({
